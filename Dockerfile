...
ARG PADDLE_DET_LIMIT_SIDE_LEN=960
...
# OCR config: server models + all preprocessing enabled; det_limit_side_len=960 (default), precision=fp16 for speed
...
det_limit = int(os.environ.get('PADDLE_DET_LIMIT_SIDE_LEN', '960')); \
p = PaddleOCR( \
